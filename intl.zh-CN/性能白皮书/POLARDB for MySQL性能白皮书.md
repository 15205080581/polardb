...
1.  获取POLARDB for MySQL集群的主地址和端口。 
    ...
    2.  单击集群ID。
    3.  在基本信息页面的访问信息中找到集群的主地址和端口，如下图所示。![基本信息](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3033/156621156734898_zh-CN.png)
...
6.  在以上测试的过程中，您可以另外打开一个会话窗口，连接该ECS实例，并使用htop查看sysbench client的CPU使用率是否正常。 
    ...
    **说明：** 
    ...
    ![CPU使用率](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3035/15662115672111_zh-CN.png)

    ![CPU使用率](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3035/15662115682112_zh-CN.png)
...
![单台ECS的log结果](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3033/156621156811337_zh-CN.png)

三台ECS实例通过集群连接串连接一个POLARDB for MySQL集群时，总QPS如下。

**说明：** 集群连接串总是连接到主实例，所以以下QPS为主实例的性能。

![QPS](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3033/156621156811333_zh-CN.png)

三台ECS实例通过集群连接串连接一个POLARDB for MySQL集群时，总TPS如下。

**说明：** 集群连接串总是连接到主实例，所以以下TPS为主实例的性能。

![TPS](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3033/156621156911334_zh-CN.png)
...
![聚合QPS](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3033/156621156911338_zh-CN.png)
