...
具体操作请参见[创建数据库账号](../../../../intl.zh-CN/POLARDB for MySQL快速入门/创建数据库账号.md)。
...
4.  找到目标账号，单击**修改密码**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3026/156594389713605_zh-CN.png)
