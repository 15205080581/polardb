...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3008/1563427787861_zh-CN.png)
...
读写分离是POLARDB for MySQL集群默认免费提供的一个透明、高可用、自适应的负载均衡能力。通过集群地址，SQL请求自动转发到POLARDB集群的各个节点，提供聚合、高吞吐的并发SQL处理能力。具体请参见[读写分离](../../../../cn.zh-CN/POLARDB for MySQL用户指南/读写分离.md)。
