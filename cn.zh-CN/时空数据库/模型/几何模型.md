# 几何模型 {#concept_977446 .concept}

Ganos Geometry是云原生关系型分布式数据库POLARDB的一个空间几何扩展，Ganos Geometry遵循OpenGIS规范，使POLARDB增加了存储和管理2D（X，Y）、3D（X，Y，Z）、4D（X，Y，Z，M）空间几何数据的能力，并提供了空间几何对象、索引、函数和操作符等丰富功能。

## 概述 {#section_5fn_zsj_8c7 .section}

几何模型完全兼容PostGIS接口，支持已有应用的平滑迁移。

## 快速入门 {#section_jr5_brj_h2z .section}
...
## SQL参考 {#section_uhs_2ya_kow .section}

详细SQL手册请参考 [PostGIS官方手册](http://postgis.net/docs/reference.html)。
