...
**说明：** POLARDB for PostgreSQL/Oracle暂不支持设置集群白名单，只有相同VPC内的实例才可以访问集群。
...
3.  在**访问信息**区域，单击**白名单列表**右侧的**配置**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3015/155736771213598_zh-CN.png)
