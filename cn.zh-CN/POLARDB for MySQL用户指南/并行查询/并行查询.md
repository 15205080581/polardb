...
![示意图](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/1240658/156860622260483_zh-CN.png)
...
关于并行查询的性能优势，请参见[并行查询使用案例](cn.zh-CN/POLARDB for MySQL用户指南/并行查询/并行查询使用示例.md#)。
