...
如果高权限账号自身出现问题，例如如权限被意外回收（REVOKE ），您可以通过输入高权限账号的密码来重置高权限账号的权限，使其恢复正常。
...
## 下一步 {#section_si5_2wy_jzo .section}

[查看连接地址](cn.zh-CN/POLARDB for Oracle用户指南/集群管理/查看连接地址.md#)
